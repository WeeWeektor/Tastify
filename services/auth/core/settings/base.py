...
SECRET_KEY = env('SECRET_KEY', default='fallback-secret-key-do-not-use-in-prod')
DEBUG = env('DEBUG')
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'authentication.pipeline.mark_social_user_verified',
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Tastify Auth API',
    'DESCRIPTION': 'API for authentication, registration, and user profiles',
    'VERSION': '1.0.0',
